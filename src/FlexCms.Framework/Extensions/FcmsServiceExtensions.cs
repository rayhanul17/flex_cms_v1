...
public static class FcmsServiceExtensions
{
        ...
        FlexCmsOptions options)
    {
        ...
        // Scan two roots so source-controlled modules at the solution-root
        // <c>modules/</c> folder are picked up alongside packaged ones that
        // landed in <c>src/FlexCms.Host/modules/</c> via the admin Upload flow.
