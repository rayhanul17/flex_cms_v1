...
public class SeedService : IHostedService
{
    ...
    [
        ...
        new() { Key = "roles.create",      DisplayName = "Roles: Create",             Group = "Admin" },
        new() { Key = "roles.edit",        DisplayName = "Roles: Edit",               Group = "Admin" },
        new() { Key = "roles.delete",      DisplayName = "Roles: Delete",             Group = "Admin" },
        ...
        new() { Key = "users.create",      DisplayName = "Users: Create",             Group = "Admin" },
        new() { Key = "users.edit",        DisplayName = "Users: Edit",               Group = "Admin" },
        new() { Key = "users.delete",      DisplayName = "Users: Delete",             Group = "Admin" },
