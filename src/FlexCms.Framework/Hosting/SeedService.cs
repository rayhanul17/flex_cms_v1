...
public class SeedService : IHostedService
{
    ...
    [
        new() { Key = FcmsPermissions.PagesView,         DisplayName = "Pages: View list",           Group = "Pages" },
        ...
        new() { Key = FcmsPermissions.PostsView,         DisplayName = "Posts: View list",           Group = "Posts" },
        ...
        new() { Key = FcmsPermissions.CategoriesView,    DisplayName = "Categories: View list",      Group = "Posts" },
        ...
        new() { Key = FcmsPermissions.RedirectsView,     DisplayName = "Redirects: View list",       Group = "Redirects" },
        ...
        new() { Key = FcmsPermissions.NotificationsView, DisplayName = "Notifications: View own",    Group = "Admin" },
        new() { Key = FcmsPermissions.NotificationsManage, DisplayName = "Notifications: Mark read",Group = "Admin" },
        new() { Key = FcmsPermissions.RolesView,         DisplayName = "Roles: View list",           Group = "Admin" },
        ...
        new() { Key = FcmsPermissions.UsersView,         DisplayName = "Users: View list",           Group = "Admin" },
        ...
        new() { Key = FcmsPermissions.ModulesManage,     DisplayName = "Modules: Manage (non-destructive)", Group = "Admin" },
        new() { Key = FcmsPermissions.ModulesUpload,     DisplayName = "Modules: Upload DLL packages",      Group = "Admin" },
